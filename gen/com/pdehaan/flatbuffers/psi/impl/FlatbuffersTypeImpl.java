...
public class FlatbuffersTypeImpl extends ASTWrapperPsiElement implements FlatbuffersType {
  ...
  public FlatbuffersTypeImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public FlatbuffersBuiltinType getBuiltinType() {
    return findChildByClass(FlatbuffersBuiltinType.class);
  }

  @Override
  @Nullable
  public FlatbuffersCustomType getCustomType() {
    return findChildByClass(FlatbuffersCustomType.class);
  }
