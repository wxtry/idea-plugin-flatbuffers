...
public class FlatbuffersMetadataImpl extends ASTWrapperPsiElement implements FlatbuffersMetadata {
  ...
  public FlatbuffersMetadataImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FlatbuffersMetadataPart> getMetadataPartList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FlatbuffersMetadataPart.class);
  }
